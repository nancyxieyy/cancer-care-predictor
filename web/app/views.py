...
def load_model():
    global survival_model, disease_model, treatment_model, survival_scaler, disease_scaler
    ...
    disease_scaler_path = os.path.join(current_app.root_path, 'models', 'disease_scaler.pkl')
...
def disease():
    ...
    if request.method == 'POST':
        try:
            ...
            input_df = disease_scaler.transform(pd.DataFrame([form_data]))
